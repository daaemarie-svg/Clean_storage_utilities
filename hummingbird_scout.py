#The detailed scout starting at 10MB instead of 500MB
...
def storage_inspection():
    print(f"--- Cloud Scout: Hummingbird Detailed Edition ---")
    ...
    choice = input("\nType a number to move Hummingbird_Trash, 'all', or 'skip':").lower()
    ...
    if choice == 'all' or choice.isdigit():
        ...
        for item in to_trash:
            ...
            print(f"Moved to Hummingbird_Trash: {item['name']}")
    else:
